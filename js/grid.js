...
Grid.prototype.updateLog = function (direction) {
  var logElement = document.getElementById("log-textbox-id");

  if (logElement) {
    logElement.value += "Move: " + direction + "\n";
